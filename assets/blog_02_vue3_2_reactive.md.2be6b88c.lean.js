import{_ as O,c as U,b,w as g,d as z,a as n,e as t,r as V,o as G,V as h}from"./app.1593a14f.js";const H={name:"component-doc",components:{"render-demo-0":function(){const{toDisplayString:a,createElementVNode:s,createTextVNode:o,resolveComponent:f,withCtx:c,createVNode:p,openBlock:C,createElementBlock:l}=h,m=o("Btn");function v(D,i){const E=f("xl-button");return C(),l("div",null,[s("div",null,[s("p",null,a(D.msg),1),p(E,{type:"primary",onClick:D.add},{default:c(()=>[m]),_:1},8,["onClick"])])])}const{reactive:x}=h;return{render:v,...{setup(D,{expose:i}){i();let E=x(0);function k(){console.log(E),E++}const _={msg:E,add:k,reactive:x};return Object.defineProperty(_,"__isScriptSetup",{enumerable:!1,value:!0}),_}}}}(),"render-demo-1":function(){const{createElementVNode:a,toDisplayString:s,createTextVNode:o,resolveComponent:f,withCtx:c,createVNode:p,openBlock:C,createElementBlock:l}=h,m={class:"reactive"},v={class:"eg"},x=a("p",null,"json\u3001\u5BF9\u8C61\u7C7B\u578B",-1),A=o("Btn"),D={class:"eg"},i=a("p",null,"\u6570\u7EC4\u7C7B\u578B",-1),E=o("Btn"),k={class:"eg"},_=a("p",null,"Date\u7C7B\u578B",-1),r=o("Btn"),d=o("Btn2");function N(F,M){const B=f("xl-button");return C(),l("div",null,[a("div",m,[a("div",v,[x,a("p",null,s(F.msg.num),1),p(B,{type:"primary",onClick:F.add},{default:c(()=>[A]),_:1},8,["onClick"])]),a("div",D,[i,a("p",null,s(F.arr),1),p(B,{type:"primary",onClick:F.addArr},{default:c(()=>[E]),_:1},8,["onClick"])]),a("div",k,[_,a("p",null,s(F.date),1),a("p",null,s(F.date2.date),1),p(B,{type:"primary",onClick:F.setDate},{default:c(()=>[r]),_:1},8,["onClick"]),p(B,{type:"primary",onClick:F.setDate2},{default:c(()=>[d]),_:1},8,["onClick"])])])])}const{reactive:y}=h;return{render:N,...{setup(F,{expose:M}){M();let B=y({num:0});function j(){console.log(B),B.num++}let w=y([1,100,3]);function P(){console.log(w),w[0]++,w[1]--}let u=y(new Date),e=y({date:new Date});function T(){u.setDate(u.getDate()+1),e.date.setDate(e.date.getDate()+1),console.log("date",u),console.log("date2",e)}function $(){u.setDate(u.getDate()+1),e.date.setDate(e.date.getDate()+1),u.setDate(u.getDate()+1),u=new Date(u),e.date.setDate(e.date.getDate()+1),e.date=new Date(e.date),console.log("date",u),console.log("date2",e)}const S={msg:B,add:j,arr:w,addArr:P,date:u,date2:e,setDate:T,setDate2:$,reactive:y};return Object.defineProperty(S,"__isScriptSetup",{enumerable:!1,value:!0}),S}}}}(),"render-demo-2":function(){const{toDisplayString:a,createElementVNode:s,createTextVNode:o,resolveComponent:f,withCtx:c,createVNode:p,vShow:C,withDirectives:l,openBlock:m,createElementBlock:v}=h,x=o("Btn"),A=o("BtnB");function D(k,_){const r=f("xl-button");return m(),v("div",null,[s("div",null,[s("p",null,a(k.proxyMsg),1),p(r,{type:"primary",onClick:k.showA},{default:c(()=>[x]),_:1},8,["onClick"]),l(p(r,{type:"primary",onClick:k.addB},{default:c(()=>[A]),_:1},8,["onClick"]),[[C,k.proxyMsg.B]])])])}const{reactive:i}=h;return{render:D,...{setup(k,{expose:_}){_();const r={a:1};let d=i(r);function N(){console.log("\u539Fvs\u4EE3\u7406:",r===d),console.log("reactive(\u539F)vs\u4EE3\u7406:",i(r)===d),console.log("reactive(\u4EE3\u7406)vs\u4EE3\u7406:",i(d)===d),d.B={b:1},console.log("B b\u5BF9\u8C61\u4E5F\u4F9D\u65E7\u662F\u4EE3\u7406")}function y(){d.B.b++}const q={msg:r,proxyMsg:d,showA:N,addB:y,reactive:i};return Object.defineProperty(q,"__isScriptSetup",{enumerable:!1,value:!0}),q}}}}()}},cn='{"title":"\u4EC0\u4E48\u662F reactive","description":"","frontmatter":{},"headers":[{"level":2,"title":"\u4EC0\u4E48\u662F reactive","slug":"\u4EC0\u4E48\u662F-reactive"},{"level":2,"title":"reactive\u4F7F\u7528","slug":"reactive\u4F7F\u7528"},{"level":2,"title":"\u54CD\u5E94\u5F0F\u4EE3\u7406 \u4E0E \u539F\u59CB\u5BF9\u8C61","slug":"\u54CD\u5E94\u5F0F\u4EE3\u7406-\u4E0E-\u539F\u59CB\u5BF9\u8C61"}],"relativePath":"blog/02_vue3/2_reactive.md","lastUpdated":1656928523000}',I=z('<h2 id="\u4EC0\u4E48\u662F-reactive" tabindex="-1">\u4EC0\u4E48\u662F reactive</h2><ol><li>reactive \u662F Vue3 \u4E2D\u63D0\u4F9B\u7684\u5B9E\u73B0\u54CD\u5E94\u5F0F\u6570\u636E\u7684\u65B9\u6CD5\u3002</li><li>\u5728 Vue2 \u4E2D\u54CD\u5E94\u5F0F\u6570\u636E\u662F\u901A\u8FC7 <code>defineProperty</code> \u6765\u5B9E\u73B0\u7684</li><li>\u5728 Vue3 \u4E2D\u54CD\u5E94\u5F0F\u6570\u636E\u662F\u901A\u8FC7 <code>ES6</code> \u7684 <code>Proxy</code>\u6765\u5B9E\u73B0\u7684\u3002</li><li>reactive \u53C2\u6570\u5FC5\u987B\u662F\u5BF9\u8C61 (<code>json</code> / <code>arr</code>)</li></ol><ul><li>\u5982\u679C\u7ED9 reactive \u4F20\u9012\u4E86\u5176\u5B83\u5BF9\u8C61 <ul><li>\u9ED8\u8BA4\u60C5\u51B5\u4E0B\uFF0C\u4FEE\u6539\u5BF9\u8C61\u65E0\u6CD5\u5B9E\u73B0\u754C\u9762\u7684\u6570\u636E\u7ED1\u5B9A\u66F4\u65B0\u3002</li><li>\u5982\u679C\u9700\u8981\u66F4\u65B0\uFF0C\u9700\u8981\u8FDB\u884C\u91CD\u65B0\u8D4B\u503C\u3002(\u5373\u4E0D\u5141\u8BB8\u76F4\u63A5\u64CD\u4F5C\u6570\u636E\uFF0C\u9700\u8981\u653E\u4E2A\u65B0\u7684\u6570\u636E\u6765\u66FF\u4EE3\u539F\u6570\u636E)</li></ul></li></ul><h2 id="reactive\u4F7F\u7528" tabindex="-1">reactive\u4F7F\u7528</h2><p><strong>reactive\u9519\u8BEF\u793A\u8303 (\u63A7\u5236\u53F0\u67E5\u770B)</strong></p>',5),J=n("div",null,"\u5728 reactive \u4F7F\u7528\u57FA\u672C\u7C7B\u578B\u53C2\u6570 \u9519\u8BEF\u793A\u8303",-1),K=n("div",{class:"language-vue line-numbers-mode"},[n("pre",null,[n("code",null,[n("span",{class:"token comment"},`<!-- 
