import{_ as w,c as x,b as g,w as C,d as N,a as n,e as s,r as A,o as h,V as f}from"./app.4f88bb76.js";const j={name:"component-doc",components:{"render-demo-0":function(){const{createTextVNode:e,resolveComponent:b,withCtx:c,createVNode:l,createElementVNode:r,openBlock:B,createElementBlock:i}=f,o=e("\u76F8\u4F3C"),k=e("NaN");function F(d,m){const a=b("xl-button");return B(),i("div",null,[r("div",null,[l(a,{onClick:d.btn,type:"primary"},{default:c(()=>[o]),_:1},8,["onClick"]),l(a,{onClick:d.btn2,type:"success"},{default:c(()=>[k]),_:1},8,["onClick"])])])}return{render:F,...{setup(d,{expose:m}){m();let a,u=null;function t(){console.log("undefined is false"),console.log("null is false"),console.log(void 0==null),console.log(void 0===null)}function p(){console.log(Number(a)),console.log(5+a),console.log("========="),console.log(Number(u)),console.log(5+u)}const E={a,b:u,btn:t,btn2:p};return Object.defineProperty(E,"__isScriptSetup",{enumerable:!1,value:!0}),E}}}}(),"render-demo-1":function(){const{createTextVNode:e,resolveComponent:b,withCtx:c,createVNode:l,toDisplayString:r,createElementVNode:B,openBlock:i,createElementBlock:o}=f,k=e("add(null)"),F=e("add()");function D(a,u){const t=b("xl-button");return i(),o("div",null,[B("div",null,[l(t,{onClick:u[0]||(u[0]=p=>a.add(null)),type:"warning"},{default:c(()=>[k]),_:1}),e(r(a.num)+" ",1),l(t,{onClick:u[1]||(u[1]=p=>a.add()),type:"danger"},{default:c(()=>[F]),_:1}),e(r(a.num),1)])])}const{ref:d}=f;return{render:D,...{setup(a,{expose:u}){u();let t=d(0);function p(v){t.value+=v}const E={num:t,add:p,ref:d};return Object.defineProperty(E,"__isScriptSetup",{enumerable:!1,value:!0}),E}}}}(),"render-demo-2":function(){const{createTextVNode:e,resolveComponent:b,withCtx:c,createVNode:l,toDisplayString:r,createElementVNode:B,openBlock:i,createElementBlock:o}=f,k=e("log");function F(m,a){const u=b("xl-button");return i(),o("div",null,[B("div",null,[l(u,{onClick:a[0]||(a[0]=t=>m.log()),type:"warning"},{default:c(()=>[k]),_:1}),e(r(m.num),1)])])}const{reactive:D}=f;return{render:F,...{setup(m,{expose:a}){a();var u;function t(_){console.log(_)}var p={name:"wenl",age:18};function E(){console.log(u),t(),console.log(p.name),console.log(p.girlFriend);const _=t("123");console.log(_)}var v=t();const y={i:u,f:t,student:p,log:E,x:v,reactive:D};return Object.defineProperty(y,"__isScriptSetup",{enumerable:!1,value:!0}),y}}}}()}},K='{"title":"1.null \u548C undefined","description":"","frontmatter":{},"headers":[{"level":2,"title":"1.null \u548C undefined","slug":"_1-null-\u548C-undefined"},{"level":3,"title":"\u76F8\u4F3C\u70B9","slug":"\u76F8\u4F3C\u70B9"},{"level":3,"title":"\u76EE\u524D\u7684\u7528\u6CD5","slug":"\u76EE\u524D\u7684\u7528\u6CD5"},{"level":2,"title":"2.Object.is\u4E0E\\"===\\",\\"==\\"\u533A\u522B","slug":"_2-object-is\u4E0E-\u533A\u522B"},{"level":3,"title":"\u5F02\u540C","slug":"\u5F02\u540C"},{"level":3,"title":"\u4E25\u683C\u76F8\u7B49\u8FD0\u7B97\u7B26 ===","slug":"\u4E25\u683C\u76F8\u7B49\u8FD0\u7B97\u7B26"},{"level":3,"title":"\u76F8\u7B49\u8FD0\u7B97\u7B26==","slug":"\u76F8\u7B49\u8FD0\u7B97\u7B26"},{"level":3,"title":"Object.is(value1, value2)","slug":"object-is-value1-value2"}],"relativePath":"blog/10_\u9762\u8BD5/02_js.md","lastUpdated":1658995367000}',q=N(`<h2 id="_1-null-\u548C-undefined" tabindex="-1">1.null \u548C undefined</h2><ul><li>\u4E00\u822C\u672A\u6307\u5B9A\u6307\u5411\u5BF9\u8C61\u7684\u6307\u9488\u4F1A\u88AB\u9ED8\u8BA4\u4E3A<code>Null</code>\u7C7B\u578B\uFF0C\u56E0\u4E3A\u4E00\u4E2A\u503C\u4E3A<code>Null</code>\u7684\u53D8\u91CF\u5176\u5B9E\u9645\u7C7B\u578B\u4E3A<code>object</code>\uFF0C\u56E0\u4E3A\u7CFB\u7EDF\u4F1A\u5C06\u5176\u89C6\u4E3A\u4E00\u4E2A\u4FDD\u5B58\u5BF9\u8C61\u7684\u53D8\u91CF\uFF0C\u53EA\u4E0D\u8FC7\u8FD8\u672A\u521D\u59CB\u5316\u3002</li><li>Java\u7406\u89E3\u5C31\u662F\uFF1Anull\u50CF\u5728Java\u91CC\u4E00\u6837\uFF0C\u88AB\u5F53\u6210\u4E00\u4E2A\u5BF9\u8C61\uFF0C\u5BF9\u4E8E Java \u6765\u8BF4\u4E0D\u53EF\u80FD\u5B58\u5728\u4E00\u4E2A\u201C\u4E0D\u5B58\u5728\u201D\u7684\u6210\u5458\uFF08\u4E0D\u5B58\u5728\u7684\u8BDD\u76F4\u63A5\u5C31\u7F16\u8BD1\u5931\u8D25\u4E86\uFF09\uFF0C\u6240\u4EE5\u53EA\u7528 null \u6765\u8868\u793A\u8BED\u4E49\u4E0A\u7684\u7A7A\u503C\u3002</li><li>\u5728JavaScript\u4E2D\uFF0C\u5C06\u4E00\u4E2A\u53D8\u91CF\u8D4B\u503C\u4E3A<code>undefined</code>\u6216<code>null</code>\uFF0C\u51E0\u4E4E\u6CA1\u533A\u522B\u3002</li><li>\u51FA\u73B0<code>undefined</code>\u539F\u56E0\uFF1A <ul><li>JavaScript\u7684\u6700\u521D\u7248\u672C\u6CA1\u6709\u5305\u62EC\u9519\u8BEF\u5904\u7406\u673A\u5236\uFF0C\u53D1\u751F\u6570\u636E\u7C7B\u578B\u4E0D\u5339\u914D\u65F6\uFF0C\u5F80\u5F80\u662F\u81EA\u52A8\u8F6C\u6362\u7C7B\u578B\u6216\u8005\u9ED8\u9ED8\u5730\u5931\u8D25</li><li>Brendan Eich\uFF08\u5F00\u53D1\u8005\uFF09\u89C9\u5F97\uFF0C\u5982\u679C<code>null</code>\u81EA\u52A8\u8F6C\u4E3A0\uFF0C<strong><code>\u5F88\u4E0D\u5BB9\u6613\u53D1\u73B0\u9519\u8BEF</code></strong>\u3002\u6240\u4EE5\u6574\u4E86\u4E2A<code>undefined </code></li></ul></li></ul><h3 id="\u76F8\u4F3C\u70B9" tabindex="-1">\u76F8\u4F3C\u70B9</h3><ul><li>undefined\u548Cnull\u5728if\u8BED\u53E5\u4E2D\uFF0C\u90FD\u4F1A\u88AB\u81EA\u52A8\u8F6C\u4E3Afalse\uFF0C\u76F8\u7B49\u8FD0\u7B97\u7B26\u751A\u81F3\u76F4\u63A5\u62A5\u544A\u4E24\u8005\u76F8\u7B49\u3002</li></ul><div class="language-js line-numbers-mode"><pre><code>
...
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div>`,25);function H(e,b,c,l,r,B){const i=A("render-demo-0"),o=A("demo"),k=A("render-demo-1"),F=A("render-demo-2");return h(),x("div",null,[q,g(o,{sourceCode:`<template>
  <div>
...
`},{description:C(()=>[V]),highlight:C(()=>[S]),default:C(()=>[g(i)]),_:1}),O,T,$,g(o,{sourceCode:`<template>
  <div>
...
`},{highlight:C(()=>[J]),default:C(()=>[g(k)]),_:1}),P,U,g(o,{sourceCode:`<template>
  <div>
...
`},{highlight:C(()=>[z]),default:C(()=>[g(F)]),_:1}),G])}var L=w(j,[["render",H]]);export{K as __pageData,L as default};
