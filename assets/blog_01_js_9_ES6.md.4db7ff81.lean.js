import{_ as I,c as O,a as y,w as m,e as T,b as n,r as B,o as G,V as v,d as t}from"./app.fdb7fb57.js";const J={name:"component-doc",components:{"render-demo-0":function(){const{toDisplayString:F,createTextVNode:e,resolveComponent:f,withCtx:p,createVNode:l,createElementVNode:o,vShow:C,withDirectives:d,openBlock:x,createElementBlock:h}=v,_=e("\u83B7\u53D6\u4EF7\u683Cprice"),b=e("\u91CD\u7F6E\u6C34\u679C"),A=o("span",null,"\u63A7\u5236\u53F0\u67E5\u770B",-1),w=o("br",null,null,-1),P=e("\u8BBE\u7F6E\u6C34\u679C\u539F\u4EF7"),N=["value"];function q(s,E){const a=f("xl-button");return x(),h("div",null,[o("div",null,[l(a,{type:"info",onClick:s.getfruit},{default:p(()=>[e("\u83B7\u53D6"+F(s.isProxy?"\u4EE3\u7406\u540E\u7684":"")+"\u6C34\u679C",1)]),_:1},8,["onClick"]),l(a,{type:"info",onClick:s.getprice},{default:p(()=>[_]),_:1},8,["onClick"]),l(a,{type:"primary",onClick:s.setProxy},{default:p(()=>[e("\u70B9\u51FB\u7ED9\u6C34\u679C\u627E\u4EE3\u7406\u5546\uFF08"+F(s.proxyNum)+"\uFF09",1)]),_:1},8,["onClick"]),l(a,{type:"warning",onClick:s.resetFruit},{default:p(()=>[b]),_:1},8,["onClick"]),A,w,d(o("div",null,[P,o("input",{type:"text",placeholder:"\u7ED9\u897F\u74DC\u8BBE\u7F6E\u4EF7\u683C",value:s.fruit.price,onInput:E[0]||(E[0]=(...r)=>s.changePrice&&s.changePrice(...r))},null,40,N)],512),[[C,s.isProxy]])])])}const{ref:g}=v;return{render:q,...{setup(s,{expose:E}){E();const a=g(!1),r=g(0);let u={name:"\u897F\u74DC",price:15};function V(){u={name:"\u897F\u74DC",price:15},a.value=!1,r.value=0,console.log("\u91CD\u7F6E\u6210\u529F")}function S(){console.log("fruit\uFF1A",u)}function j(){console.log("name\uFF1A",u.name)}function $(){console.log("price\uFF1A",u.price)}function z(i){u.price=Number.parseInt(i.target.value)}function R(){u=new Proxy(u,{get(i,k){let c=i[k];return k==="price"&&(c+=5),c},set(i,k,c){if(k==="price"&&c>100)throw Error("\u53EF\u4E0D\u80FD\u592A\u8D35\u4E86");return console.log(`\u5DF2\u8BBE\u7F6E\u4EF7\u683C\u4E3A${c}`),Reflect.set(i,k,c)}}),a.value=!0,r.value++,console.log("\u4EE3\u7406\u6210\u529F")}const D={isProxy:a,proxyNum:r,fruit:u,resetFruit:V,getfruit:S,getName:j,getprice:$,changePrice:z,setProxy:R,ref:g};return Object.defineProperty(D,"__isScriptSetup",{enumerable:!1,value:!0}),D}}}}()}},nn='{"title":"var let const\u533A\u522B","description":"","frontmatter":{},"headers":[{"level":2,"title":"var let const\u533A\u522B","slug":"var-let-const\u533A\u522B"},{"level":2,"title":"proxy","slug":"proxy"},{"level":3,"title":"\u7406\u89E3","slug":"\u7406\u89E3"},{"level":3,"title":"\u53C2\u8003\u8D44\u6599","slug":"\u53C2\u8003\u8D44\u6599"}],"relativePath":"blog/01_js/9_ES6.md","lastUpdated":1659431111000}',M=T(`<h2 id="var-let-const\u533A\u522B" tabindex="-1">var let const\u533A\u522B</h2><table><tbody><tr><th>\u5173\u952E\u5B57</th><th>\u53D8\u91CF\u63D0\u5347</th><th>\u5757\u7EA7\u4F5C\u7528\u57DF</th><th>\u91CD\u590D\u58F0\u660E\u540C\u540D\u53D8\u91CF</th><th>\u91CD\u65B0\u8D4B\u503C</th></tr><tr><td>var</td><td>\u221A</td><td>\xD7</td><td>\u221A</td><td>\u221A</td></tr><tr><td>let</td><td>\xD7</td><td>\u221A</td><td>\xD7</td><td>\u221A</td></tr><tr><td>const</td><td>\xD7</td><td>\u221A</td><td>\xD7</td><td>\xD7</td></tr></tbody></table><h2 id="proxy" tabindex="-1">proxy</h2><blockquote><p>\u53EA\u505A\u7B80\u5230\u4E0D\u80FD\u518D\u7B80\u7684\u7B80\u4ECB\uFF0C\u8BE6\u7EC6\u7528\u6CD5\u8BF7\u67E5\u9605<a href="https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Proxy" target="_blank" rel="noopener noreferrer">MDN</a>\u548C<a href="https://es6.ruanyifeng.com/#docs/proxy" target="_blank" rel="noopener noreferrer">\u962E\u4E00\u5CF0ES6</a></p></blockquote><h3 id="\u7406\u89E3" tabindex="-1">\u7406\u89E3</h3><p>Proxy \u53EF\u4EE5\u7406\u89E3\u6210\uFF0C\u5728\u76EE\u6807\u5BF9\u8C61\u4E4B\u524D\u67B6\u8BBE\u4E00\u5C42\u201C\u62E6\u622A\u201D\uFF0C\u5916\u754C\u5BF9\u8BE5\u5BF9\u8C61\u7684\u8BBF\u95EE\uFF0C\u90FD\u5FC5\u987B\u5148\u901A\u8FC7\u8FD9\u5C42\u62E6\u622A\uFF0C\u56E0\u6B64\u63D0\u4F9B\u4E86\u4E00\u79CD\u673A\u5236\uFF0C\u53EF\u4EE5\u5BF9\u5916\u754C\u7684\u8BBF\u95EE\u8FDB\u884C\u8FC7\u6EE4\u548C\u6539\u5199\u3002Proxy \u8FD9\u4E2A\u8BCD\u7684\u539F\u610F\u662F\u4EE3\u7406\uFF0C\u7528\u5728\u8FD9\u91CC\u8868\u793A\u7531\u5B83\u6765\u201C\u4EE3\u7406\u201D\u67D0\u4E9B\u64CD\u4F5C\uFF0C\u53EF\u4EE5\u8BD1\u4E3A\u201C\u4EE3\u7406\u5668\u201D\u3002</p><ul><li>\u8BED\u6CD5</li></ul><div class="language-js line-numbers-mode"><pre><code><span class="token keyword">let</span> p <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Proxy</span><span class="token punctuation">(</span>target<span class="token punctuation">,</span> handler<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers-wrapper"><span class="line-number">1</span><br></div></div><p><strong>\u6C34\u679C\u4EE3\u7406\u5546\u6848\u4EE3\u5165\u7406\u89E3</strong></p>`,9),W=n("div",null,"\u4EE3\u7406 \u7406\u89E3\u7B80\u5355\u6848\u4F8B",-1),U=n("div",{class:"language-vue line-numbers-mode"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
...
`},{description:m(()=>[W]),highlight:m(()=>[U]),default:m(()=>[y(C)]),_:1}),H,K,L,Q])}var tn=I(J,[["render",X]]);export{nn as __pageData,tn as default};
